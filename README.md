...
- ΠΡΟΣΟΧΗ! Πριν την εκτέλεση του προγράμματος διαβάστε τις γραμμές 93-96 και 105 -108
===============================================================================================================================================
1. Περιγραφή: 
...
f. steiner_method.h : enumeration της κάθε μεθόδου που μπορεί να προσθέσει σημείο steiner.
g. extra_graphics.h : γραφικά για την εκτύπωση του CDT με χρωματισμό των τριγώνων που είναι αμβλυγώνια, των κορυφών όπου υπάρχει αμβλεία γωνία, αλλά και εμφάνιση των συντεταγμένων κάθε κορυφής.
...
Η επιλογή του L στο SA είναι στα 1650 loops γιατί αυξομειώνουμε την θερμκρασία μέχρι εκείνη την στιγμή, με σκοπό να φύγουμε από τοπικό ελάχιστο.
